...
Export one or more finalized cross-section artifacts as plain CSV tables for
external collaborators while retaining the within-cell phi covariance:

```bash
python3 analysis/export_reduced_cross_sections.py \
