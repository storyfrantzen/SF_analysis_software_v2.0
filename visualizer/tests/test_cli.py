...
class VisualizerCliTests(unittest.TestCase):
    ...
    def run_visualizer(self, command: list[str], output_name: str) -> str:
        ...
        self.assertIn('<div class="canvas-toolbar" aria-label="Display options">', html)
        ...
        self.assertIn("container: plot-section / inline-size", html)
        self.assertIn("@container plot-section (max-width: 800px)", html)
