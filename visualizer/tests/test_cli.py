...
class VisualizerCliTests(unittest.TestCase):
    ...
    def run_visualizer(self, command: list[str], output_name: str) -> str:
        ...
        self.assertIn("grid-template-columns: minmax(390px, 1.55fr) repeat(2, minmax(220px, 1fr))", html)
        self.assertIn("width: min(100%, 1000px)", html)
        ...
        self.assertIn("slot.style.minHeight = comparing", html)
